...
import com.pp.couchdblib.couchbase.lite.internal.AttachmentInternal;
...
import com.pp.couchdblib.couchbase.lite.replicator.Puller;
import com.pp.couchdblib.couchbase.lite.replicator.Pusher;
import com.pp.couchdblib.couchbase.lite.replicator.Replication;
import com.pp.couchdblib.couchbase.lite.storage.ContentValues;
import com.pp.couchdblib.couchbase.lite.storage.Cursor;
import com.pp.couchdblib.couchbase.lite.storage.SQLException;
import com.pp.couchdblib.couchbase.lite.storage.SQLiteStorageEngine;
import com.pp.couchdblib.couchbase.lite.storage.SQLiteStorageEngineFactory;
import com.pp.couchdblib.couchbase.lite.support.Base64;
import com.pp.couchdblib.couchbase.lite.support.FileDirUtils;
import com.pp.couchdblib.couchbase.lite.support.HttpClientFactory;
import com.pp.couchdblib.couchbase.lite.util.Log;
import com.pp.couchdblib.couchbase.lite.util.LruCache;
...
public class Database {
    ...
    public boolean initialize(String statements) {
        try {
        	...
        	Log.e("Couchdb:","sql exception:"+e.getMessage());
            close();
            return false;
        }
        return true;
    ...
    public boolean open() {
        ...
        if(dbVersion < 1) {
            ...
            if(!initialize(SCHEMA)) {
            	Log.e(TAG,"Cannot initialize SCHEMA:");
                database.close();
                return false;
            }
            dbVersion = 3;
