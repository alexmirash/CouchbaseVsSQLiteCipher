...
public class Document {
    ...
    private static void checkMapForNull(Map map) {
	HashSet setToRemove = new HashSet();
	for (Object o : map.keySet()) {
		...
		if (map.get(o) instanceof Map) {
		    checkMapForNull((Map) map.get(o));
		}
	    }
	}
	for (Object o : setToRemove) {
	    map.remove(o);
	}
    }
